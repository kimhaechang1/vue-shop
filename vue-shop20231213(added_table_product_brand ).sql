...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_product_brand_to_product_brand_product_brand_id` FOREIGN KEY (`product_brand`) REFERENCES `product_brand` (`product_brand_id`)
...
INSERT INTO `product_brand` VALUES (1,'NIKE'),(2,'ADIDAS'),(3,'ASICS');
...
-- Dump completed on 2023-12-13 23:01:09
